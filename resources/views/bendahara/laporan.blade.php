    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @if (isset($transaksis))
                ...
                <div class="mb-3">
                    <a href="javascript:window.print()" class="btn btn-success"><i class="fa fa-print"></i> Cetak Tabel</a>
                </div>
                <div class="box box-primary" id="print-area">
                    <div class="box-body table-responsive">
                        {{-- Judul untuk cetakan --}}
                        <div class="text-center mb-4" style="margin-bottom: 20px;">
                            <h3 style="font-weight: bold; text-transform: uppercase;">Laporan Pemasukan</h3>
                            <h4>
                                Periode:
                                {{ \Carbon\Carbon::parse($bulan_terpilih->created_at)->startOfMonth()->translatedFormat('d F Y') }} -
                                {{ \Carbon\Carbon::parse($bulan_terpilih->created_at)->endOfMonth()->translatedFormat('d F Y') }}
                            </h4>
                        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($transaksis as $transaksi)
                                    ...
                                    <tr>
                                        ...
                                        @for ($i = 1; $i <= 4; $i++)
                                            <td style="color: {{ $transaksi->{'minggu_' . $i} == 'LUNAS' ? 'green' : 'red' }}">
